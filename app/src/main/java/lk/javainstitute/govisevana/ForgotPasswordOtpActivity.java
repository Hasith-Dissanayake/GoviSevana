...
public class ForgotPasswordOtpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resetProgressBar = findViewById(R.id.resetprogressBar2);
        ...
        PhoneAuthOptions.Builder builder = PhoneAuthOptions.newBuilder(mAuth)
                ...
                .setCallbacks(new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            mAuth.signInWithCredential(phoneAuthCredential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (task.isSuccessful()) {
                                       Toast.makeText(ForgotPasswordOtpActivity.this,"OTP Verified Automatically!",Toast.LENGTH_SHORT).show();
                    ...
                    public void onVerificationFailed(@NonNull FirebaseException e) {
                        Toast.makeText(ForgotPasswordOtpActivity.this,"OTP Verification Failed: "+ e.getMessage(),Toast.LENGTH_LONG).show();
                        setInProgress(false);
                        isProcessing = false;
                    }
                    ...
                    public void onCodeSent(@NonNull String s, @NonNull PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                        ...
                        Toast.makeText(ForgotPasswordOtpActivity.this,"OTP Sent Successfully",Toast.LENGTH_LONG).show();
    ...
    private void verifyOTP() {
        ...
        if (enteredOTP.length() < 6) {
            Toast.makeText(ForgotPasswordOtpActivity.this, "Please enter a valid 6-digit code", Toast.LENGTH_SHORT).show();
            setInProgress(false);
            isProcessing = false;
            return;
        }
        ...
        if (verificationCode == null) {
            Toast.makeText(ForgotPasswordOtpActivity.this,"Please request OTP again.",Toast.LENGTH_LONG).show();
            setInProgress(false);
            isProcessing = false;
            return;
        }
        ...
        mAuth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    Toast.makeText(ForgotPasswordOtpActivity.this,"OTP Verified Successfully!",Toast.LENGTH_LONG).show();
                    navigateToNextActivity();
                } else {
                    Toast.makeText(ForgotPasswordOtpActivity.this,"Invalid OTP. Try Again.",Toast.LENGTH_LONG).show();
    ...
    private void navigateToNextActivity() {
        if (!isFinishing()) {
            Intent intent = new Intent(ForgotPasswordOtpActivity.this, ForgotNewPasswordActivity.class);
